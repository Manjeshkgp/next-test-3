    ...
    >
      <div className="bg-[#00C074] h-[50vh] w-screen flex items-end overflow-hidden lg:h-screen lg:w-[55vw] lg:justify-center">
        ...
        data-aos='fade-up'
          src={img2}
          alt="img1"
          className="max-w-[65vw] md:max-w-[50vw] -mb-[6vh] md:-mb-[8vh] ml-[10vw] md:ml-[20vw] -mr-[50vw] self-end z-10 object-top lg:w-[27vw] lg:m-0 lg:-mr-[15vw] lg:-mb-[25vh] lg:ml-[5vw]"
        />
        <Image
        data-aos='fade-up'
          src={img1}
          alt="img2"
          className="max-w-[65vw] md:max-w-[50vw] scale-75 -mb-[18vh] md:-mb-[20vh] ml-[15vw] md:ml-[25vw] -mr-[20vw] self-end z-0 object-top lg:w-[23vw] lg:m-0 lg:-mb-[25vh]"
        />
      </div>
      <div className="bg-emerald-600 z-10 h-[50vh] w-screen relative flex flex-col items-center gap-y-[2vh] lg:h-screen lg:w-[45vw] lg:justify-end lg:pb-[6vh] lg:gap-y-[5vh] lg:pl-[3vw] lg:items-start">
        ...
        />
        <p data-aos='flip-up' className="w-[90%] md:text-[40px] md:leading-[45px] font-bold text-3xl mt-[15vh] lg:mt-0">
          ABC 23478
        </p>
