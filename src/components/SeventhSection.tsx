...
const SeventhSection: FC<SeventhSectionProps> = ({ scrollPosition, vh }) => {
  return (
    <section
      id="section7"
      className={
        scrollPosition > 6 * vh - 50 && scrollPosition < 7 * vh
    ...
    >
      ...
      <div className="bg-emerald-600 z-10 h-[50vh] w-screen relative flex flex-col items-center gap-y-[2vh] lg:h-screen lg:w-[45vw] lg:justify-end lg:pb-[6vh] lg:gap-y-[5vh] lg:items-start lg:pl-[4vw]">
        <Image
          src={appOfTheyr}
          alt="img2"
