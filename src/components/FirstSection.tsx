...
const FirstSection: FC<FirstSectionProps> = ({ scrollPosition, vh }) => {
  return (
    ...
    >
      ...
      <div className="bg-purple-700 h-[50vh] lg:h-screen lg:w-[45vw] w-screen relative flex flex-col items-center gap-y-[2vh] lg:gap-y-[5vh] lg:justify-end lg:items-start lg:pl-[3vw] lg:pb-[6vh]">
        <Image
          src={digitalCommImg}
          alt="img2"
        ...
        <p className="w-[90%] md:text-[35px] md:leading-[40px] flex justify-start items-center gap-x-[2vw] font-semibold text-xl lg:text-base lg:mt-[6vh]">
